function table({setCreateShipmentModel, allShipmentdata}){
...
<div className="items-start justify-between md:flex">
    <div className="max-w-lg">
        ...
        <p className="text-gray-600 mt-2">this is the dapp for tracking and now here we put the dummy text here</p>
    </div>
