...
function Startshipment({startModal, setStartModal , startShipment}){
            ...
            <div className="relative w-full max-w-lg p-4 mx-auto bg-white rounded-md shadow-lg">
                <div className="flex justify-end">
                    ...
                    <div className="relative mt-3">
                        <input type="text" placeholder="receiver" className="w-full pl-5 pr-3 py-2 text-gray-500 bg-transparent
                        ...
                        <button onClick={()=>startShipping()} className="block w-full mt-3 py-3 px-4 font-medium text-sm text-center
